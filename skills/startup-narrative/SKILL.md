...
6. **`mission_vision.md`** — mission (what the company does and for whom, in one sentence, true today), vision (the world if it succeeds, 10 years out), values (3–5, each phrased as a **trade-off the company will actually make**, not a virtue it admires), and the "why we exist". Distinct from positioning: positioning is defined against competitors, mission is independent of them and survives their disappearance.
