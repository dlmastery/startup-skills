...
- **Counts:** 100 rows · **78 required · 22 optional**. **Status as of 2026-08-29 (reconciled to the glob): 78 images rendered, 12 HTML infographics rendered.** A row is marked rendered only when the file exists on disk with nonzero size — verified, not assumed.
